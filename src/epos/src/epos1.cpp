...
int main(int argc, char** argv){
    ...
    //ROS Initialize
    ros::init(argc, argv, "epos_right");


    ros::NodeHandle n;
    
    ros::Publisher enc_pub = n.advertise<balldroid_msgs::Encoder>("/epos/enc/right", 10);
    ros::Publisher vel_pub = n.advertise<balldroid_msgs::Encoder>("/epos/vel/right", 10);
